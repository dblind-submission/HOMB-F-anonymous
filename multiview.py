...
#SBATCH --job-name=student-100
#SBATCH --time=5-00:00:00
#SBATCH --mem=128G
#SBATCH --output=/data/gpfs/projects/punim1824/%u/hpc_output/ML4O_output/REPORT_%x-%j.out
#SBATCH --error=/data/gpfs/projects/punim1824/%u/hpc_output/ML4O_output/REPORT_%x-%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mojgan.kouhounestani@student.unimelb.edu.a
